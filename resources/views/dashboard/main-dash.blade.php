...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
      ...
      <li class="accordion-button collapsed " data-bs-toggle="collapse" data-bs-target="#flush-collapseOne">
        <a class="has-arrow" href="#" ><i class="icon-speedometer menu-icon"></i><span class="nav-label">Dashboard</span>
